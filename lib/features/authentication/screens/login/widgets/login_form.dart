...
class _TLoginFormState extends State<TLoginForm> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>(); // Local key
  final LoginController controller = Get.find<LoginController>();

  @override
  void dispose() {
    // Nếu cần thiết, bạn có thể giải phóng các TextEditingController ở đây
    super.dispose();
  }
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(lang.translate('forgetPassword')),
                ),
              ],
            ),
            const SizedBox(height: DSize.spaceBtwSection),
