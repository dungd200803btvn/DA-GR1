...
import '../controller/group_request_controller.dart';
...
class GroupRequestScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final GroupRequestController controller = GroupRequestController.instance;
    var lang = AppLocalizations.of(context);
    return Scaffold(
      appBar: TAppBar(
        title: Text(
          lang.translate('group_request'),
      ...
      body: Obx(() {
        ...
        if (controller.requests.isEmpty) {
          return Center(child: Text(lang.translate('no_group_request'),));
        }
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            final GroupRequestModel request = controller.requests[index];
            return Card(
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () async {
                              await controller.updateGroupRequestStatus(
                                request,
                                'accepted',
                                context,
                              );
